  ...
  return (
    <div className="flex flex-col gap-6 items-center w-full">
      ...
      >
		...
		<button  className="bg-black cursor-pointer text-white p-2 rounded-lg">Login</button>
      </form>
	  <h1>Don`t have an account? <NavLink to="/auth/register" className=" underline">Register</NavLink></h1>
    </div>
  );
};
