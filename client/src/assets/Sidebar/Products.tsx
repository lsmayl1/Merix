...
const Products = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    ...
    <path d="M2.70113 8.6485L15 15.7659L27.2154 8.69028" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15 28.3853V15.7521" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"/>
