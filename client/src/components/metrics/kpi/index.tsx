...
export const KPI = ({ data, className }: { data: data; className: string }) => {
  return (
    <div
      className="grid gap-2 md:[grid-template-columns:repeat(var(--cols),minmax(0,1fr))] grid-cols-1 w-full"
